...
class DuitkuController extends Controller
{
    public function createInvoice(Request $request)
    {
        ...
        if($tagihan->tagihanStatus == "Lunas")
        {
            ...
            $callbackUrl        = 'https://pdam.withmangg.my.id/transaksi/handle-notification-duitku'; // url for callback
            $returnUrl          = 'https://pdam.withmangg.my.id/layanan/transaksi'; // url for redirect
